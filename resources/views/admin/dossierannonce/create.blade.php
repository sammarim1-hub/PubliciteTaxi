...
@section('title', 'create | dossierannonce' )
    ...
    <div class="container my-3">
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                ...
                {{-- form begin --}}
                <form action="{{ route('dossierannonce.store') }}" method="post" enctype="multipart/form-data" class="">
                    @csrf
                    ...
                    <div class="card shadow-lg">
                        ...
                        {{--card title--}}
                        <div class="card-header fs-4 fw-bold">Create dossierannonce</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <div class="row align-items-center">
                                    <div class="col-md-3">
                                        <label for="">Insert DateCreation : </label>
                                    </div>
                                    <div class="col-md-9">
                            ...
                            <div class="mb-3">
                                <div class="row align-items-center">
                                    <div class="col-md-3">
                                        <label for="">Choose Annonceur</label>
                                    </div>
                                    <div class="col-md-9">
                            ...
                            <div class="mb-3">
                                <div class="row align-items-center">
                                    <div class="col-md-3">
                                        <label for="">Choose Service Publicitaire</label>
                                    </div>
                                    <div class="col-md-9">
